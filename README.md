...
Install the Unity version we will use: **2022.3.62f1 (LTS)**
Install GitHub Desktop: https://desktop.github.com/
(If you don't have)Install **VS Code** for editing scripts
...
Open Unity Hub and then click "Add project from disk".
Select the cloned folder.
Open it with Unity version **2022.3.62f1**.
